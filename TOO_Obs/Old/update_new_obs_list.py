...
#---------------------------------------------------------------------------------------------
#-- pre_assigned_pos: assign a pre-assigned poc                                             --
#---------------------------------------------------------------------------------------------

def pre_assigned_pos(object, grating):
    """
    assign a pre-assigned poc 
    input:  object  --- object name
            grating --- gratng
    output: poc     --- if there is no pre assigned poc, return 0
    """
    ...
    elif target in  ['mercury', 'venus','earth','mars','jupiter','saturn', 'uranus', 'neptune', 'ploto']:
        poc = 'sjw'

    elif grating.lower() in ('letg', 'hetg'):
        poc = grating.lower()
    else:
        poc = 0
